...
Unittest classes:
    TestAirBnBCommand_prompting
    TestAirBnBCommand_help
...
class TestAirBnBCommand_prompting(unittest.TestCase):
    """Unittests for testing prompting of the AirBnB command interpreter."""

    def test_prompt_string(self):
        self.assertEqual("(AirBnB) ", AirBnBCommand.prompt)
...
class TestAirBnBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(AirBnBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(AirBnBCommand().onecmd("create User"))
            testId = output.getvalue().strip()
...
class TestAirBnBCommand_count(unittest.TestCase):
    """Unittests for testing count method of AirBnB comand interpreter."""
